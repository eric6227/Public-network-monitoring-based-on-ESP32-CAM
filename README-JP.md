...
- ファイル [app_httpd.cpp](app_httpd.cpp) は Espressif Systems に由来し、[Apache License 2.0](LICENSE-APACHE-2.0) を採用しています。
...
2. **状況とコメントに応じてコードを変更する**
   ...
   - 151 行目でフレームレートを設定します。計算方法：`1000 / 値 = FPS`。たとえば、33（デフォルト）に設定すると、約 30 FPS になります。
